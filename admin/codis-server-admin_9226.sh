...
CODIS_SERVER_PID_FILE=/tmp/redis_9226.pid

CODIS_SERVER_LOG_FILE=/tmp/redis_9226.log
CODIS_SERVER_DAEMON_FILE=$CODIS_LOG_DIR/codis-server-9226.out

CODIS_SERVER_CONF_FILE=$CODIS_CONF_DIR/redis_9226.conf
